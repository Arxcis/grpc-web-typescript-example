...
goog.exportPath_ = function (path, b, c) {
  const parts = path.split(".");
  c = c || goog.global;
  parts[0] in c ||
    "undefined" == typeof c.execScript ||
    c.execScript("var " + parts[0]);
  for (var d; parts.length && (d = parts.shift()); )
    !parts.length && goog.isDef(b)
      ? (c[d] = b)
...
export const Message = jspb.Message;
export const BinaryReader = jspb.BinaryReader;
export const BinaryWriter = jspb.BinaryWriter;
