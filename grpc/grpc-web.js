...
function ra(a, b, c, d) {
  return d instanceof pa
    ? d
    : new pa(a, c, d.b || b.constructor, d.f, d.a, d.c);
}
function B(a) {
  this.a = a;
}
...
function Fa(a) {
  a: {
    var b = Ga;
    for (
      var c = a.length, d = "string" === typeof a ? a.split("") : a, f = 0;
      f < c;
      f++
    )
...
var Ta = E(G, "Opera"),
  ...
  Va =
    E(G, "Gecko") &&
    !(E(G.toLowerCase(), "webkit") && !E(G, "Edge")) &&
    !(E(G, "Trident") || E(G, "MSIE")) &&
    !E(G, "Edge"),
...
function eb() {
  0 != fb &&
    ((Object.prototype.hasOwnProperty.call(this, ja) && this[ja]) ||
      (this[ja] = ++ka));
  this.F = this.F;
}
var fb = 0;
...
M.prototype.add = function (a, b, c, d, f) {
  ...
  -1 < e
    ? ((b = a[e]), c || (b.v = !1))
    : ((b = new nb(b, this.src, g, !!d, f)), (b.v = c), a.push(b));
  return b;
};
function qb(a, b) {
  var c = b.type;
...
function ub(a, b, c, d, f) {
  if (d && d.once) vb(a, b, c, d, f);
    ...
    (c = wb(c)),
      a && a[L]
        ? a.f.add(String(b), c, !1, u(d) ? !!d.capture : !!d, f)
        : xb(a, b, c, !1, d, f);
}
  ...
  if ("number" !== typeof a && a && !a.s) {
    ...
    if (b && b[L]) qb(b.f, a);
      ...
      b.removeEventListener
        ...
        : b.detachEvent
        ? b.detachEvent(Ab(c), d)
        : b.addListener && b.removeListener && b.removeListener(d);
      tb--;
      (c = yb(b))
        ? (qb(c, a), 0 == c.b && ((c.src = null), (b[rb] = null)))
        : ob(a);
    }
  }
}
...
function ac(a, b) {
  if (b instanceof Q)
    for (var c = b.f(), d = 0; d < c.length; d++) a.set(c[d], b.get(c[d]));
  ...
  try {
    kc(a),
      0 < a.l &&
        ...
        P(
          a.b,
          T(a, "Will abort after " + a.l + "ms if incomplete, xhr2 " + a.B)
        ),
        a.B
          ? ((a.a.timeout = a.l), (a.a.ontimeout = w(a.L, a)))
          : (a.u = Jb(a.L, a.l, a))),
      P(a.b, T(a, "Sending request")),
      (a.m = !0),
      a.a.send(b),
      (a.m = !1);
  } catch (g) {
...
S.prototype.L = function () {
  "undefined" != typeof ha &&
    this.a &&
    ((this.i = "Timed out after " + this.l + "ms, aborting"),
    (this.g = 8),
    P(this.b, T(this, this.i)),
    O(this, "timeout"),
    this.abort(8));
};
function jc(a, b) {
...
function pc(a) {
  try {
    ...
    b &&
      b.log(
        Ob,
        "Response type " + a.j + " is not supported on this browser",
        void 0
      );
    return null;
  } catch (c) {
...
function W(a) {
      ...
      if (d)
        for (c = 0; c < d.length; c++) {
          ...
          if (D in d[c] && 0 < d[c][D].length) {
            ...
            h = "";
            "grpc-status" in f &&
              ((e = f["grpc-status"]), delete f["grpc-status"]);
            "grpc-message" in f &&
              ((h = f["grpc-message"]), delete f["grpc-message"]);
  ...
  ub(this.a, "complete", function () {
    ...
    if (0 != c) {
      ...
      (10 == e && b.j) || X(b, { code: e, message: sa(c), metadata: {} });
    } else (c = !1), "grpc-status" in g && ((e = qc(b.a, "grpc-status")), "grpc-message" in g && (d = qc(b.a, "grpc-message")), 0 != Number(e) && (X(b, { code: Number(e), message: d, metadata: g }), (c = !0))), c || yc(b);
  });
}
      ...
      Cc(
        ...
        function (v, x, F, Eb) {
          v
            ...
            : Eb
            ? (m = Eb)
            : ((v = e.getMethodDescriptor()),
              (x = m),
              (x = void 0 === x ? {} : x),
              h(new A(n, v, x, void 0 === p ? null : p)));
        },
        !0
      );
    });
...
function Bc(a, b, c) {
  ...
  if (R(c.headers.b, "deadline")) {
    ...
    var h = c.headers;
    R(h.b, "deadline") &&
      (delete h.b.deadline, h.c--, h.a.length > 2 * h.c && bc(h));
    Infinity === e && (e = 0);
      ...
      if (((e = zc(e)), "string" === typeof f)) {
        if (
          ...
          (e = f.indexOf("#")),
            0 > e && (e = f.length),
            (h = f.indexOf("?")),
            0 > h || h > e ? ((h = e), (k = "")) : (k = f.substring(h + 1, e)),
            (f = [f.substr(0, h), k, f.substr(e)]),
            (e = f[1]),
            (f[1] = m ? (e ? e + "&" + m : m) : e),
            (f = f[0] + (f[1] ? "?" + f[1] : "") + f[2]);
...
function Cc(a, b, c) {
  ...
  a.on("status", function (g) {
    0 == g.code || f
      ? c && b(null, null, g)
      : ((f = !0),
        b({ code: g.code, message: g.details, metadata: g.metadata }, null));
  });
  if (c)
  ...
  a.on("end", function () {
    f ||
      (null == d ? b({ code: 2, message: "Incomplete response" }) : b(null, d));
    c && b(null, null);
  });
}
function Ac(a, b) {
...
export const AbstractClientBase = {
...
export const GrpcWebClientBase = Z;
